...
<body>
	...
	<div id="navbar" class="wrap">
		...
		<dl class="search clearfix">
			<form method="post" action="house" id='sform'>
				<dt>
					<ul>
	...
	<div class="main wrap">
				...
				<s:iterator value="houseList" status="status">
					<tr>
						<td class="house-thumb">
							<span> 
								<s:url value="house!show" id="show">
						...
						<td class="house-type"><s:property value="type.name" />
						</td>
		...
		<div class="pager">
			<ul>
				...
				<li><s:url id="nex" value="index.action">
				...
				<li><s:url id="last" value="index.action">
